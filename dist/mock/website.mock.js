export const mockWebsite = `<div class="widget block block-static-block">
              ...
              <div class="col-xs-4">
                  <div class="package featured-right" style="margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:25px">
                      ...
                      <div class="package-features">
                          <ul>
                              <li>
                                  <div class="package-name">First description</div>
                              </li>
                              <li>
      ...
      <div class="pricing-table">
          <div class="row-subscriptions" style="margin-bottom:40px;">
                  ...
                  <div class="package featured-right" style="margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:25px">
                      ...
                      <div class="package-features">
                          <ul>
                              ...
                              <li>
                                  <div class="package-price"><span class="price-big">£50.00</span><br>(inc. VAT)<br>Per Year
                                      <p style="color: red">Save £1.11 on the monthly price</p>
                                  </div>
                              </li>
                              <li>
              ...
              <div class="col-xs-4">
                  <div class="package featured center" style="margin-left:0px;">
                      <div class="header dark-bg">
                          <h3>Second: 12GB Data - 1 Year</h3>
                      </div>
                      <div class="package-features">
                          <ul>
                              <li>
                                  <div class="package-name">Second description</div>
                              </li>
                              <li>
                                  <div class="package-description">Up to 12GB of data per year<br> including 420 SMS<br>(5p / MB data and 4p / SMS thereafter)</div>
                              </li>
                              <li>
                                  <div class="package-price"><span class="price-big">£100.00</span><br>(inc. VAT)<br>Per Year
                                     <p style="color: red">Save £2.22 on the monthly price</p>
                                  </div>
                              </li>
                              <li>
                                  <div class="package-data">Annual - Data &amp; SMS Service Only</div>
              ...
              <!-- PACKAGE THREE -->
               <div class="col-cs-4">
                  <div class="package featured-right" style="margin-top:0px; margin-left:0px; margin-bottom:0px">
                      <div class="header dark-bg">
                          <h3>Third: 24GB Data - 1 Year</h3>
                      </div>
                      <div class="package-features">
                          <ul>
                              <li>
                                  <div class="package-name">Third description</div>
                              </li>
                              <li>
                                  <div class="package-description">Up to 12GB of data per year<br> including 480 SMS<br>(5p / MB data and 4p / SMS thereafter)</div>
                              </li>
                              <li>
                                  <div class="package-price"><span class="price-big">£150.00</span><br>(inc. VAT)<br>Per Year
                                     <p style="color: red">Save £3.33 on the monthly price</p>
                                  </div>
                              </li>
                              <li>
                                  <div class="package-data">Annual - Data &amp; SMS Service Only</div>
...
//# sourceMappingURL=website.mock.js.map